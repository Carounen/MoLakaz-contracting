...
header("Location: changecpassword.php");
return;
}
$stmt = $pdo->prepare("SELECT contractor_id, password
FROM contractor where contractor_id = :coid");
$stmt->execute(
array(
':coid' => $_SESSION['coid']
)
...
$sql = "UPDATE contractor SET password = :pass WHERE contractor_id = :coid";
