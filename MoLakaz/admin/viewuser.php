...
<?php
  ...
  $stmt = $pdo->prepare("SELECT * FROM user LIMIT :offset, :recordsPerPage");
    ...
    <div id="searchresult" class="row mt-3">
        ...
        <div class="card-deck mt-3">
            <?php foreach ($users as $user): ?>
                <div class="card">
                    <img src="upload/<?php echo htmlentities($user["profile_image"]); ?>" class="card-img-top" style="max-height: 500px;" alt="Profile Image">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo htmlentities($user["firstname"]) . ' ' . htmlentities($user["lastname"]); ?></h5>
                        <p class="card-text"><strong>Email:</strong> <?php echo htmlentities($user["email"]); ?></p>
                        <p class="card-text"><strong>Description:</strong> <?php echo htmlentities($user["description"]); ?></p>
                    </div>
