...
$stmt = $pdo->prepare("SELECT * FROM user WHERE firstname LIKE
:st");
$stmt->execute(
array(
':st' => $st
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
    <div class="course-item">
        <img class="img-fluid" alt="" src="upload/<?php echo htmlentities($row["profile_image"]); ?>" style="max-height: 200px;">
        <div class="course-content">
            ...
            <div class="card-footer">
                <a href="view_profile.php?id=<?php echo $row['user_id']; ?>" class="btn btn-primary">View Profile</a>
            </div>
        </div>
    </div> <!-- End Item -->
<?php endwhile; 
